    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-6 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4">CarRental</h3>
            <p className="text-gray-300 mb-4">
              Providing quality car rental services with a wide range of vehicles to meet your needs.
            </p>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300">© {currentYear} CarRental. All rights reserved.</p>
